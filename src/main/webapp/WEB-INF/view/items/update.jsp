			...
			<form action="update">
				<div class="user-details">
					...
					<div class="col-12 col-sm-6">
						<div>
							<label>Category</label> <select class="form-control select"
								name="category" value="${param.category}" id="box">
					...
					<div class="input-box">
						...
						<input type="text" name="manufacturer" value="${param.manufacturer}" required>
					</div>
					<div class="input-box">
						<span class="details">stock</span> 
						<input type="text" name="stock" value="${param.stock}" required>
					</div>
